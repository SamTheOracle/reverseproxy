...
public class ProxyServer extends BaseProxy {
    ...
    public void start(Promise<Void> startPromise) throws Exception {
        ...
        router.route(Config.ROOT_PATH + "/*")
                .method(HttpMethod.DELETE)
                .method(HttpMethod.POST)
                .method(HttpMethod.PUT)
                .handler(this::handleRerouteWithBody);
        router.get(Config.ROOT_PATH + "/*")
                .method(HttpMethod.GET)
                .handler(this::handleCacheGet);
    ...
    private void handleRerouteWithBody(RoutingContext routingContext) {
    ...
    private void handleCacheGet(RoutingContext routingContext) {
        HttpServerRequest httpServerRequest = routingContext.request();
        HttpMethod method = httpServerRequest.method();
        MultiMap headers = httpServerRequest.headers();
